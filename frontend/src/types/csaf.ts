// Based on: https://docs.oasis-open.org/csaf/csaf/v2.0/os/schemas/csaf_json_schema.json
 ...
 */
export type ListOfAcknowledgedNames = [
  NameOfTheContributor,
  ...NameOfTheContributor[],
];
/**
 ...
 */
export type VulnerabilityAcknowledgments = [
  Acknowledgment,
  ...Acknowledgment[],
];
/**
 ...
 */
export type ListOfEntitlements = [
  EntitlementOfTheRemediation,
  ...EntitlementOfTheRemediation[],
];
/**
...
export interface ProductStatus {
  first_affected?: ListOfProductIds;
  first_fixed?: ListOfProductIds;
  fixed?: ListOfProductIds;
  known_affected?: ListOfProductIds;
  known_not_affected?: ListOfProductIds;
  last_affected?: ListOfProductIds;
  recommended?: ListOfProductIds;
  under_investigation?: ListOfProductIds;
  [k: string]: unknown;
}
/**
