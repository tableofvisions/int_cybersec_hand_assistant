...
const Privacy = () => {
  return (
    <BackgroundPanel contentClassName="p-10 md:ps-20">
      <div className="space-y-10 max-w-[75ch]">
        <p>Zuletzt aktualisiert am 01.12.2024</p>
        ...
        <div className="space-y-3">
          ...
          <p>
            ...
            datenschutzbeauftragter∂kit edu oder der Postadresse mit dem Zusatz
        ...
        <div className="space-y-3">
          <h2 className="c-h2">Cookie Manager</h2>
          <p>
        ...
        <div className="space-y-3">
          <h2 className="c-h2">Cookies</h2>
          <h2 className="c-h2">a) Sitzungs-Cookies/Session-Cookies</h2>
          <p>
          ...
          <h2 className="c-h2">b) Drittanbieter-Cookies</h2>
          <p>
          ...
          <h2 className="c-h2">c) Beseitigungsmöglichkeit</h2>
          <p>
        ...
        <div className="space-y-3">
          <h2 className="c-h2">Kontaktanfragen / Kontaktmöglichkeit</h2>
          <p>
        ...
        <div className="space-y-3">
          <h2 className="c-h2">Kundenkonto / Registrierungsfunktion</h2>
          <p>
            ...
            E-Mail-Adresse) ausschließlich für vorvertragliche Leistungen, für
            die Vertragserfüllung oder zum Zwecke der Kundenpflege (bspw. um
            Ihnen eine Übersicht über Ihre bisherigen Bestellungen bei uns zur
            Verfügung zu stellen oder um Ihnen die sog. Merkzettelfunktion
            anbieten zu können) erheben und speichern. Gleichzeitig speichern
            wir dann die IP-Adresse und das Datum Ihrer Registrierung nebst
            Uhrzeit. Eine Weitergabe dieser Daten an Dritte erfolgt natürlich
            nicht.
          </p>
          <p>
          ...
          <p>
            ...
            Rechtsgrundlage für diese Verarbeitung auch noch Art. 6 Abs. 1 lit.
            b) DSGVO.
          </p>
          <p>
        ...
        <div className="space-y-3">
          <h2 className="c-h2">Serverdaten</h2>
          <p>
